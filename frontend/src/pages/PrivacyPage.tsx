  ...
  return (
    <div className="container">
      ...
      <section>
        ...
        <p>
          When you use CINENICHE, we may collect the following types of personal
          data:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            interact with our platform, such as movies you watch or search for.
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          We only process your data for specific and lawful purposes, including:
        </p>
        <ul>
      ...
      <section>
        ...
        <p>
          ...
          Optional cookies (e.g., for analytics) will only be set with your
          consent.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          only under strict data processing agreements.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Address: <strong>[insert physical address, if applicable]</strong>
        </p>
      </section>
    </div>
  );
